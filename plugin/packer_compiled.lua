...
_G.packer_plugins = {
  ...
  ["colorbuddy.nvim"] = {
    loaded = true,
    path = "/Users/Tony/.local/share/nvim/site/pack/packer/start/colorbuddy.nvim",
    url = "https://github.com/tjdevries/colorbuddy.nvim"
  },
  ["git.nvim"] = {
    loaded = true,
    path = "/Users/Tony/.local/share/nvim/site/pack/packer/start/git.nvim",
  ...
  ["markdown-preview.nvim"] = {
    loaded = true,
    path = "/Users/Tony/.local/share/nvim/site/pack/packer/start/markdown-preview.nvim",
  ...
  ["nvim-bufferline.lua"] = {
    loaded = true,
    path = "/Users/Tony/.local/share/nvim/site/pack/packer/start/nvim-bufferline.lua",
  ...
  ["telescope-file-browser.nvim"] = {
    loaded = true,
    path = "/Users/Tony/.local/share/nvim/site/pack/packer/start/telescope-file-browser.nvim",
  ...
  ["vim-colors-solarized.git"] = {
    loaded = true,
    path = "/Users/Tony/.local/share/nvim/site/pack/packer/start/vim-colors-solarized.git",
  ...
  ["vim-which-key"] = {
    loaded = true,
    path = "/Users/Tony/.local/share/nvim/site/pack/packer/start/vim-which-key",
    url = "https://github.com/liuchengxu/vim-which-key"
  },
  ["zen-mode.nvim"] = {
    loaded = true,
    path = "/Users/Tony/.local/share/nvim/site/pack/packer/start/zen-mode.nvim",
